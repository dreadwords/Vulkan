...
void VulkanGear::generate(GearInfo *gearinfo, VkQueue queue)
{
	...
	double r0, r1, r2;
	double ta, da;
	double u1, v1, u2, v2, len;
	double cos_ta, cos_ta_1da, cos_ta_2da, cos_ta_3da, cos_ta_4da;
	double sin_ta, sin_ta_1da, sin_ta_2da, sin_ta_3da, sin_ta_4da;
	...
	for (i = 0; i < gearinfo->numTeeth; i++)
	{
		...
		ix0 = newVertex(&vBuffer, (float)(r0 * cos_ta), (float)(r0 * sin_ta), (float)(gearinfo->width * 0.5), normal);
		ix1 = newVertex(&vBuffer, (float)(r1 * cos_ta), (float)(r1 * sin_ta), (float)(gearinfo->width * 0.5), normal);
		ix2 = newVertex(&vBuffer, (float)(r0 * cos_ta), (float)(r0 * sin_ta), (float)(gearinfo->width * 0.5), normal);
		ix3 = newVertex(&vBuffer, (float)(r1 * cos_ta_3da), (float)(r1 * sin_ta_3da), (float)(gearinfo->width * 0.5), normal);
		ix4 = newVertex(&vBuffer, (float)(r0 * cos_ta_4da), (float)(r0 * sin_ta_4da), (float)(gearinfo->width * 0.5), normal);
		ix5 = newVertex(&vBuffer, (float)(r1 * cos_ta_4da), (float)(r1 * sin_ta_4da), (float)(gearinfo->width * 0.5), normal);
		...
		normal = glm::vec3(0.0, 0.0, 1.0);
		ix0 = newVertex(&vBuffer, (float)(r1 * cos_ta), (float)(r1 * sin_ta), (float)(gearinfo->width * 0.5), normal);
		ix1 = newVertex(&vBuffer, (float)(r2 * cos_ta_1da), (float)(r2 * sin_ta_1da), (float)(gearinfo->width * 0.5), normal);
		ix2 = newVertex(&vBuffer, (float)(r1 * cos_ta_3da), (float)(r1 * sin_ta_3da), (float)(gearinfo->width * 0.5), normal);
		ix3 = newVertex(&vBuffer, (float)(r2 * cos_ta_2da), (float)(r2 * sin_ta_2da), (float)(gearinfo->width * 0.5), normal);
		newFace(&iBuffer, ix0, ix1, ix2);
		newFace(&iBuffer, ix1, ix3, ix2);
		...
		normal = glm::vec3(0.0, 0.0, -1.0);
		ix0 = newVertex(&vBuffer, (float)(r1 * cos_ta), (float)(r1 * sin_ta), (float)(-gearinfo->width * 0.5), normal);
		ix1 = newVertex(&vBuffer, (float)(r0 * cos_ta), (float)(r0 * sin_ta), (float)(-gearinfo->width * 0.5), normal);
		ix2 = newVertex(&vBuffer, (float)(r1 * cos_ta_3da), (float)(r1 * sin_ta_3da), (float)(-gearinfo->width * 0.5), normal);
		ix3 = newVertex(&vBuffer, (float)(r0 * cos_ta), (float)(r0 * sin_ta), (float)(-gearinfo->width * 0.5), normal);
		ix4 = newVertex(&vBuffer, (float)(r1 * cos_ta_4da), (float)(r1 * sin_ta_4da), (float)(-gearinfo->width * 0.5), normal);
		ix5 = newVertex(&vBuffer, (float)(r0 * cos_ta_4da), (float)(r0 * sin_ta_4da), (float)(-gearinfo->width * 0.5), normal);
		newFace(&iBuffer, ix0, ix1, ix2);
		newFace(&iBuffer, ix1, ix3, ix2);
		newFace(&iBuffer, ix2, ix3, ix4);
		newFace(&iBuffer, ix3, ix5, ix4);
		...
		// back sides of teeth 
		normal = glm::vec3(0.0, 0.0, -1.0);
		ix0 = newVertex(&vBuffer, (float)(r1 * cos_ta_3da), (float)(r1 * sin_ta_3da), (float)(-gearinfo->width * 0.5), normal);
		ix1 = newVertex(&vBuffer, (float)(r2 * cos_ta_2da), (float)(r2 * sin_ta_2da), (float)(-gearinfo->width * 0.5), normal);
		ix2 = newVertex(&vBuffer, (float)(r1 * cos_ta), (float)(r1 * sin_ta), (float)(-gearinfo->width * 0.5), normal);
		ix3 = newVertex(&vBuffer, (float)(r2 * cos_ta_1da), (float)(r2 * sin_ta_1da), (float)(-gearinfo->width * 0.5), normal);
		newFace(&iBuffer, ix0, ix1, ix2);
		newFace(&iBuffer, ix1, ix3, ix2);
		...
		ix0 = newVertex(&vBuffer, (float)(r1 * cos_ta), (float)(r1 * sin_ta), (float)(gearinfo->width * 0.5), normal);
		ix1 = newVertex(&vBuffer, (float)(r1 * cos_ta), (float)(r1 * sin_ta), (float)(-gearinfo->width * 0.5), normal);
		ix2 = newVertex(&vBuffer, (float)(r2 * cos_ta_1da), (float)(r2 * sin_ta_1da), (float)(gearinfo->width * 0.5), normal);
		ix3 = newVertex(&vBuffer, (float)(r2 * cos_ta_1da), (float)(r2 * sin_ta_1da), (float)(-gearinfo->width * 0.5), normal);
		newFace(&iBuffer, ix0, ix1, ix2);
		newFace(&iBuffer, ix1, ix3, ix2);

		normal = glm::vec3(cos_ta, sin_ta, 0.0);
		ix0 = newVertex(&vBuffer, (float)(r2 * cos_ta_1da), (float)(r2 * sin_ta_1da), (float)(gearinfo->width * 0.5), normal);
		ix1 = newVertex(&vBuffer, (float)(r2 * cos_ta_1da), (float)(r2 * sin_ta_1da), (float)(-gearinfo->width * 0.5), normal);
		ix2 = newVertex(&vBuffer, (float)(r2 * cos_ta_2da), (float)(r2 * sin_ta_2da), (float)(gearinfo->width * 0.5), normal);
		ix3 = newVertex(&vBuffer, (float)(r2 * cos_ta_2da), (float)(r2 * sin_ta_2da), (float)(-gearinfo->width * 0.5), normal);
		newFace(&iBuffer, ix0, ix1, ix2);
		newFace(&iBuffer, ix1, ix3, ix2);

		normal = glm::vec3(v2, -u2, 0.0);
		ix0 = newVertex(&vBuffer, (float)(r2 * cos_ta_2da), (float)(r2 * sin_ta_2da), (float)(gearinfo->width * 0.5 ), normal);
		ix1 = newVertex(&vBuffer, (float)(r2 * cos_ta_2da), (float)(r2 * sin_ta_2da), (float)(-gearinfo->width * 0.5), normal);
		ix2 = newVertex(&vBuffer, (float)(r1 * cos_ta_3da), (float)(r1 * sin_ta_3da), (float)(gearinfo->width * 0.5 ), normal);
		ix3 = newVertex(&vBuffer, (float)(r1 * cos_ta_3da), (float)(r1 * sin_ta_3da), (float)(-gearinfo->width * 0.5), normal);
		newFace(&iBuffer, ix0, ix1, ix2);
		...
		normal = glm::vec3(cos_ta, sin_ta, 0.0);
		ix0 = newVertex(&vBuffer, (float)(r1 * cos_ta_3da), (float)(r1 * sin_ta_3da), (float)(gearinfo->width * 0.5), normal);
		ix1 = newVertex(&vBuffer, (float)(r1 * cos_ta_3da), (float)(r1 * sin_ta_3da), (float)(-gearinfo->width * 0.5), normal);
		ix2 = newVertex(&vBuffer, (float)(r1 * cos_ta_4da), (float)(r1 * sin_ta_4da), (float)(gearinfo->width * 0.5), normal);
		ix3 = newVertex(&vBuffer, (float)(r1 * cos_ta_4da), (float)(r1 * sin_ta_4da), (float)(-gearinfo->width * 0.5), normal);
		newFace(&iBuffer, ix0, ix1, ix2);
		newFace(&iBuffer, ix1, ix3, ix2);

		// draw inside radius cylinder 
		ix0 = newVertex(&vBuffer, (float)(r0 * cos_ta), (float)(r0 * sin_ta), (float)(-gearinfo->width * 0.5), glm::vec3(-cos_ta, -sin_ta, 0.0));
		ix1 = newVertex(&vBuffer, (float)(r0 * cos_ta), (float)(r0 * sin_ta), (float)(gearinfo->width * 0.5), glm::vec3(-cos_ta, -sin_ta, 0.0));
		ix2 = newVertex(&vBuffer, (float)(r0 * cos_ta_4da), (float)(r0 * sin_ta_4da), (float)(-gearinfo->width * 0.5), glm::vec3(-cos_ta_4da, -sin_ta_4da, 0.0));
		ix3 = newVertex(&vBuffer, (float)(r0 * cos_ta_4da), (float)(r0 * sin_ta_4da), (float)(gearinfo->width * 0.5), glm::vec3(-cos_ta_4da, -sin_ta_4da, 0.0));
		newFace(&iBuffer, ix0, ix1, ix2);
		newFace(&iBuffer, ix1, ix3, ix2);
	}
	...
	indexBuffer.count = (uint32_t)iBuffer.size();
